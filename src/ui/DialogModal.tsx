            ...
            <Dialog as="div" className="relative z-30" onClose={()=>setIsOpen(false)}>
                ...
                <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                    <div className="flex min-h-full items-end justify-center p-0 text-center sm:items-center sm:p-0">
                        ...
                        >
                            <Dialog.Panel className="relative transform overflow-hidden rounded-t-xl backdrop-blur-md bg-white/70 text-left shadow-xl transition-all sm:my-8 w-full sm:max-w-lg">
                                {children}
                            </Dialog.Panel>
                        </Transition.Child>
                    </div>
